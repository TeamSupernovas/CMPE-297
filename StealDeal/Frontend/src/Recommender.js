      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            {
              role: 'user',
              content: `Here are the products: ${JSON.stringify(products)}. Based on these, recommend something for the query: "${input}".`,
            },
          ],
        }),
      });
...
export default RecommenderChatBot;